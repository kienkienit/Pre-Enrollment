-- Bước 1: Tìm danh sách các khách hàng có hơn 10 đơn hàng trong năm nay
...
-- Bước 2: Lấy thông tin đơn hàng đầu tiên và đơn hàng thứ hai gần nhất của các khách hàng này
